...
window.OLYMPUS_PUBLIC = {
  ...
  honesty: [
    ...
    "LiteLLM Admin UI is Cognito-gated at olympus.levkesha.com/litellm/ui → ClusterIP :4000. Headroom/Theseus/spend stay ClusterIP (Headroom :8787 not on that path).",
    "CLI build hop is laptop compose; platform proxy is EKS ClusterIP.",
    "n8n stays on n8n.levkesha.com at / — n8n 2.25 does not support a reverse-proxy path under olympus.levkesha.com (only n8n cannot sit under Olympus as a path).",
    ...
    "Optional LiteLLM health probe POSTs n8n /webhook/litellm-demo → ClusterIP :4000. Admin primary CTA is Cognito at olympus.levkesha.com/litellm/ui.",
  ],
};

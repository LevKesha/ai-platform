...
window.OLYMPUS_PUBLIC = {
  ...
  honesty: [
    ...
    "LiteLLM Admin UI is Cognito-gated at olympus.levkesha.com/litellm → ClusterIP :4000. Headroom/Theseus/spend stay ClusterIP (Headroom :8787 not on that path).",
    ...
    "Optional LiteLLM health probe POSTs n8n /webhook/litellm-demo → ClusterIP :4000. Admin primary path is Cognito at olympus.levkesha.com/litellm.",
  ],
};

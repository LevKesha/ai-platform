...
window.OLYMPUS_PUBLIC = {
  ...
  honesty: [
    ...
    "LiteLLM Admin UI is Cognito-gated at litellm.levkesha.com → ClusterIP :4000. Headroom/Theseus/spend stay ClusterIP (Headroom :8787 not on that host).",
    ...
    "Optional LiteLLM health probe POSTs n8n /webhook/litellm-demo → ClusterIP :4000. Admin /ui primary path is Cognito at litellm.levkesha.com.",
  ],
};
